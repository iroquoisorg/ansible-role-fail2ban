...
[![Build Status](https://travis-ci.com/iroquoisorg/ansible-role-fail2ban.svg?branch=master)](https://travis-ci.com/iroquoisorg/ansible-role-memcached)
...
`$ ansible-galaxy install iroquoisorg.fail2ban`
